...
export class WordComponent implements OnInit {
  ...
  constructor(protected wordService: WordService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.words = [];
  ...
  loadAll(): void {
    ...
    this.wordService
      ...
      .subscribe({
        next: (res: HttpResponse<IWord[]>) => {
          this.isLoading = false;
          this.paginateWords(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateWords(data: IWord[] | null, headers: HttpHeaders): void {
